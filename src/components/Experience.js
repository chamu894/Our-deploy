...
import SahanDilusha from "../../public/images/profile/SahanDilusha.jpg";
...
const Details = ({ position, name, companyLinks, time, address, work }) => {
  ...
  return (
    <li
      ref={ref}
      className="my-16 xl:my-5 lg:my-10 md:my-6 sm:text-start first:mt-0 last:mb-0 w-[60%] xl:w-[70%] xs:w-[90%] mx-auto flex flex-col  items-center justify-between md:w-[80%]"
    >
      ...
      >
        ...
        <p className=" font-medium w-full xl:text-sm md:text-xs ml-10">
          {work}
        </p>
      </motion.div>
    </li>
